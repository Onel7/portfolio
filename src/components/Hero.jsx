    ...
    <section id="accueil" className="container-page relative flex min-h-0 items-start pb-12 pt-24 sm:pb-16 sm:pt-28 lg:min-h-screen lg:items-center lg:pt-36">
      <div className="grid w-full items-center gap-8 sm:gap-10 lg:grid-cols-[1.05fr_.95fr] lg:gap-12">
        <div className="hero-enter">
          ...
          <h1 className="max-w-4xl text-[clamp(2.35rem,12.5vw,4.5rem)] font-extrabold leading-[.98] tracking-[-0.055em] text-white lg:text-[82px]">O’nel iloris<br/><span className="text-cyan-400">SEGBOZO</span></h1>
        ...
        <div className="hero-enter-delay relative mx-auto w-full max-w-[400px] sm:max-w-[480px] lg:max-w-[560px]">
